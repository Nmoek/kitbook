...
// Source: D:./internal/service/article_es.go
//
// Generated by this command:
//
//	mockgen.exe -source=D:./internal/service/article_es.go -package=svcmocks -destination=./internal/service/mocks/article.mock.go
//
