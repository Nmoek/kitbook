...
// Source: D:./internal/repository/cache/user.go
//
// Generated by this command:
//
//	mockgen.exe -source=D:./internal/repository/cache/user.go -package=cachemocks -destination=./internal/repository/cache/mocks/user.mock.go
//
