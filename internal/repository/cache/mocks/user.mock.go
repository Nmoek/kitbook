...
// Source: D:./internal/repository/cache/user_es.go
//
// Generated by this command:
//
//	mockgen.exe -source=D:./internal/repository/cache/user_es.go -package=cachemocks -destination=./internal/repository/cache/mocks/user.mock.go
//
