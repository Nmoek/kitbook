...
// Source: D:./internal/repository/dao/user.go
//
// Generated by this command:
//
//	mockgen.exe -source=D:./internal/repository/dao/user.go -package=daomocks -destination=./internal/repository/dao/mocks/user.mock.go
//
