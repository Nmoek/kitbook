...
// Source: D:./internal/repository/dao/user_es.go
//
// Generated by this command:
//
//	mockgen.exe -source=D:./internal/repository/dao/user_es.go -package=daomocks -destination=./internal/repository/dao/mocks/user.mock.go
//
