...
// Source: D:./internal/repository/article_reader.go
//
// Generated by this command:
//
//	mockgen.exe -source=D:./internal/repository/article_reader.go -package=repomocks -destination=./internal/repository/mocks/article_reader.mock.go
//
