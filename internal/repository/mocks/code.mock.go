...
// Source: D:./internal/repository/code.go
//
// Generated by this command:
//
//	mockgen.exe -source=D:./internal/repository/code.go -package=repomocks -destination=./internal/repository/mocks/code.mock.go
//
