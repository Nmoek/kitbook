...
// Source: D:./internal/repository/user_es.go
//
// Generated by this command:
//
//	mockgen.exe -source=D:./internal/repository/user_es.go -package=repomocks -destination=./internal/repository/mocks/user.mock.go
//
...
func (m *MockUserRepository) UpdatePersonalInfo(ctx context.Context, user domain.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdatePersonalInfo", ctx, user)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdatePersonalInfo indicates an expected call of UpdatePersonalInfo.
func (mr *MockUserRepositoryMockRecorder) UpdatePersonalInfo(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdatePersonalInfo", reflect.TypeOf((*MockUserRepository)(nil).UpdatePersonalInfo), ctx, user)
}
