...
// Source: D:./internal/repository/user.go
//
// Generated by this command:
//
//	mockgen.exe -source=D:./internal/repository/user.go -package=repomocks -destination=./internal/repository/mocks/user.mock.go
//
