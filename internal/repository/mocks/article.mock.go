...
// Source: D:./internal/repository/article_es.go
//
// Generated by this command:
//
//	mockgen.exe -source=D:./internal/repository/article_es.go -package=repomocks -destination=./internal/repository/mocks/article.mock.go
//
