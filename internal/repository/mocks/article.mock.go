...
// Source: D:./internal/repository/article.go
//
// Generated by this command:
//
//	mockgen.exe -source=D:./internal/repository/article.go -package=repomocks -destination=./internal/repository/mocks/article.mock.go
//
