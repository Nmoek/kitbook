...
// @func: selectClient
// @date: 2024-01-10 01:48:41
// @brief: 流量控制算法-选择使用哪一种调度方式
// @author: Kewin Li
// @receiver i
...
func (i *InteractiveClient) IncreaseReadCnt(ctx context.Context, in *intrv1.IncreaseReadCntRequest, opts ...grpc.CallOption) (*intrv1.IncreaseReadCntResponse, error) {
	return i.selectClient().IncreaseReadCnt(ctx, in, opts...)
}
