...
func InitPaymentClient(cli *etcdv3.Client) payv1.PaymentServiceClient {
	type Config struct {
	...
	viper.OnConfigChange(func(in fsnotify.Event) {
		cfg := Config{}
		err2 := viper.UnmarshalKey("grpc.client.payment", &cfg)
		if err2 != nil {
			panic(err2)
		}
	})

	return payv1.NewPaymentServiceClient(cc)
}
